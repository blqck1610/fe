      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/" element={<BaseLayout />}>
            ...
            <Route path="/product/details" element={<ProductDetails product={product/>} />
            ...
            <Route path="/account/add" element={ <PrivateRoute> <Address /> </PrivateRoute>} />
            <Route path="/confirm" element={<PrivateRoute> <Confirm /> </PrivateRoute>} />
            <Route path="/order_detail" element={<PrivateRoute> <OrderDetail /> </PrivateRoute>} />
          </Route>
