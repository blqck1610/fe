...
import { fetchArrivalProducts, fetchMenProducts, fetchWomenProducts, fetchLimelightProducts } from "../../services/ProductService";
...
const HomeScreen = (props) => {
  ...
  const getMenProducts = async () => {
    let menPrd = await fetchMenProducts();
    if(menPrd && menPrd.content){
      setMenProducts(menPrd.content);
    }
  }
