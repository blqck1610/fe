...
const SignInScreen = (props) => {
  ...
  const handleSignIn = async() => {
    ...
    try {
      ...
      let response = await UserService.getAccessToken(email, password);
      localStorage.setItem({'access_token' : response.access_token), refresh_token : response.refresh_token});
          ...
          <div className="form-grid-content">
            ...
            <div className="form-grid-right">
              ...
              <form>
                ...
                {/* type="submit" */}
                <Button variant="primary" size="lg"  className="form-submit-btn" onClick={()=>handleSignIn()} >
                  Sign In
                </Button>
              </form>
