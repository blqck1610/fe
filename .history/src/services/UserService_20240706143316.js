...
const getAccessToken = (username, password) => {
  ...
  return axios.post(getTokenConfig.url,  {client_id: getTokenConfig.client_id, client_secret: getTokenConfig.client_secret, grant_type: getTokenConfig.grant_type, username: username, password: password}, headers);
